#ifndef _PARTICLES_PIT_RECORDS_CELL_H
#define _PARTICLES_PIT_RECORDS_CELL_H
...
namespace particles {
    ...
    *
    * @date   03/10/2014 14:47
    */
   class particles::pit::records::Cell { 
      
      public:
         
         typedef particles::pit::records::CellPacked Packed;
         ...
         struct PersistentRecords {
            ...
            #endif
            #ifdef UseManualAlignment
            tarch::la::Vector<DIMENSIONS,double> _myNorm __attribute__((aligned(VectorisationAlignment)));
            #else
            tarch::la::Vector<DIMENSIONS,double> _myNorm;
            #endif
            bool _isInside;
            State _state;
            #ifdef UseManualAlignment
 ...
 #endif 
 {
            ...
            inline void setCellIndex(const int& cellIndex) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
             ...
             * @see convert()
             */
            inline tarch::la::Vector<DIMENSIONS,double> getMeanVelocity() const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
             ...
             * @see convert()
             */
            inline void setMeanVelocity(const tarch::la::Vector<DIMENSIONS,double>& meanVelocity) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
 ...
 #endif 
 {
             ...
             * @see convert()
             */
            inline tarch::la::Vector<DIMENSIONS,double> getMyNorm() const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
             ...
             * @see convert()
             */
            inline void setMyNorm(const tarch::la::Vector<DIMENSIONS,double>& myNorm) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
 ...
 #endif 
 {
      ...
      private: 
         ...
         int _numberOfParticlesInChildren;
 ...
 #endif 
 {
            return _persistentRecords._cellIndex;
         }
 ...
 #endif 
 {
            _persistentRecords._cellIndex = cellIndex;
         }
         
         
         
         inline int getNumberOfParticlesInChildren() const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            return _numberOfParticlesInChildren;
         }
         
         
         
         inline void setNumberOfParticlesInChildren(const int& numberOfParticlesInChildren) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            _numberOfParticlesInChildren = numberOfParticlesInChildren;
         }
 ...
 #endif 
 {
            return _persistentRecords._meanVelocity;
         }
 ...
 #endif 
 {
            _persistentRecords._meanVelocity = (meanVelocity);
         }
         
         
         
         inline double getMeanVelocity(int elementIndex) const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            ...
            return _persistentRecords._meanVelocity[elementIndex];
            
         }
         
         
         
         inline void setMeanVelocity(int elementIndex, const double& meanVelocity) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
 ...
 #endif 
 {
            return _persistentRecords._myNorm;
         }
 ...
 #endif 
 {
            _persistentRecords._myNorm = (myNorm);
         }
         
         
         
         inline double getMyNorm(int elementIndex) const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            assertion(elementIndex>=0);
            assertion(elementIndex<DIMENSIONS);
            return _persistentRecords._myNorm[elementIndex];
            
         }
         
         
         
         inline void setMyNorm(int elementIndex, const double& myNorm) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            assertion(elementIndex>=0);
            assertion(elementIndex<DIMENSIONS);
            _persistentRecords._myNorm[elementIndex]= myNorm;
 ...
 #endif 
 {
      ...
      class particles::pit::records::CellPacked { 
         ...
         public:
            ...
            typedef particles::pit::records::Cell::State State;
